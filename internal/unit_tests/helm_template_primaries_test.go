...
// TestEnterpriseContainsBackupPorts checks for backup ports in the services when backup disabled and enabled
func TestEnterpriseContainsBackupPorts(t *testing.T) {
	t.Parallel()
